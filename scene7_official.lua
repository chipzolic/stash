...
local comix1 = display.newImage("proassets/issue1/eng/9.png")
local comix1full = display.newImage("proassets/issue1/eng/9.png")
...
next_scene.goto = "scene8_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene6_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene7_official", false);
