...
local comix1 = display.newImage("proassets/issue2/eng/4.png")
local comix1full = display.newImage("proassets/issue2/eng/4.png")
...
function go0()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX+435, y=display.contentCenterY+400})
...
comix1.x = display.contentCenterX + 435
comix1.y = display.contentCenterY + 400
comix1.alpha = 1
...
backpage_previous.goto = "scene1_book2"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene2_book2", false);
