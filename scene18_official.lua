...
local comix1 = display.newImage("proassets/issue1/eng/21.png")
local comix1full = display.newImage("proassets/issue1/eng/21.png")
...
next_scene.goto = "scene19_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene17_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene18_official", false);
