...
local comix1 = display.newImage("proassets/issue1/eng/10.png")
local comix1full = display.newImage("proassets/issue1/eng/10.png")
...
next_scene.goto = "scene9_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene7_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene8_official", false);
