...
local comix1 = display.newImage("proassets/issue1/eng/15.png")
local comix1full = display.newImage("proassets/issue1/eng/15.png")
...
next_scene.goto = "scene13_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene11_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene12_official", false);
