...
local comix1 = display.newImage("proassets/issue1/eng/17.png")
local comix1full = display.newImage("proassets/issue1/eng/17.png")
...
next_scene.goto = "scene15_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene13_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene14_official", false);
