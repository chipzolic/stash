...
local comix1 = display.newImage("proassets/issue1/eng/16.png")
local comix1full = display.newImage("proassets/issue1/eng/16.png")
...
next_scene.goto = "scene14_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene12_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene13_official", false);
