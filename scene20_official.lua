...
local comix1 = display.newImage("proassets/issue1/eng/23.png")
local comix1full = display.newImage("proassets/issue1/eng/23.png")
...
next_scene.goto = "scene21_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene19_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene20_official", false);
