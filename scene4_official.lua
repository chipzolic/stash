...
local comix1 = display.newImage("proassets/issue1/eng/6.png")
local comix1full = display.newImage("proassets/issue1/eng/6.png")
...
next_scene.goto = "scene5_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene3_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene4_official", false);
