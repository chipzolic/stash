...
local comix1 = display.newImage("proassets/issue1/eng/22.png")
local comix1full = display.newImage("proassets/issue1/eng/22.png")
...
next_scene.goto = "scene20_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene18_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene19_official", false);
