...
local comix1 = display.newImage("proassets/issue1/eng/20.png")
local comix1full = display.newImage("proassets/issue1/eng/20.png")
...
function go1()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX-550, y=display.contentCenterY+450})
    --comix1:scale( 3.9, 3.9 )
    nextpage1.alpha = 0;
    nextpage2.alpha = 1;
    nextpage3.alpha = 0;
...
next_scene.goto = "scene18_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene16_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene17_official", false);
