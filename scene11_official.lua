...
local comix1 = display.newImage("proassets/issue1/eng/13.png")
local comix1full = display.newImage("proassets/issue1/eng/13.png")
...
next_scene.goto = "scene12_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene10_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene11_official", false);
