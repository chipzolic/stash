...
local comix1 = display.newImage("proassets/issue2/eng/3.png")
local comix1full = display.newImage("proassets/issue2/eng/3.png")
...
backpage_previous.goto = "scene0_book2"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene1_book2", false);
