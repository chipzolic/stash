...
local comix1 = display.newImage("proassets/issue1/eng/26.png")
local comix1full = display.newImage("proassets/issue1/eng/26.png")
...
next_scene.goto = "scene24_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene22_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene23_official", false);
