...
local comix1 = display.newImage("proassets/issue1/eng/25.png")
local comix1full = display.newImage("proassets/issue1/eng/25.png")
...
next_scene.goto = "scene23_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene21_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene22_official", false);
