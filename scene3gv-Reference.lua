...
local comix1 = display.newImage("3.png")
local comix1full = display.newImage("3.png")
...
function go0()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX+1300, y=display.contentCenterY+800})
...
function go1()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX+1100, y=display.contentCenterY-800})
    --comix1:scale( 3.9, 3.9 )
    nextpage1.alpha = 0;
    nextpage2.alpha = 1;
    nextpage3.alpha = 0;
...
function go2()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX-100, y=display.contentCenterY+800})
    --comix1:scale( 3.9, 3.9 )
...
function go3()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX, y=display.contentCenterY-700})
    --comix1:scale( 3.9, 3.9 )
    nextpage1.alpha = 0;
    nextpage2.alpha = 0;
    nextpage3.alpha = 0;
...
function go4()
    transition.to(comix1, {time=500, alpha=0, x=display.contentCenterX, y=display.contentCenterY})
    --comix1:scale( 3.9, 3.9 )
...
comix1:scale( 3.9, 3.9 )
comix1.x = display.contentCenterX + 1300
comix1.y = display.contentCenterY + 800
comix1.alpha = 1
--bg.width = screenWidth
--bg.height = screenHeight
--comix1.rotation = 90
