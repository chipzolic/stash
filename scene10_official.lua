...
local comix1 = display.newImage("proassets/issue1/eng/12.png")
local comix1full = display.newImage("proassets/issue1/eng/12.png")
...
next_scene.goto = "scene11_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene9_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene10_official", false);
