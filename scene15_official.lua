...
local comix1 = display.newImage("proassets/issue1/eng/18.png")
local comix1full = display.newImage("proassets/issue1/eng/18.png")
...
next_scene.goto = "scene16_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene14_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene15_official", false);
