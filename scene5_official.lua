...
local comix1 = display.newImage("proassets/issue1/eng/7.png")
local comix1full = display.newImage("proassets/issue1/eng/7.png")
...
next_scene.goto = "scene6_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene4_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene5_official", false);
