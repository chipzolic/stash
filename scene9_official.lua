...
local comix1 = display.newImage("proassets/issue1/eng/11.png")
local comix1full = display.newImage("proassets/issue1/eng/11.png")
...
function go0()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX+485, y=display.contentCenterY+550})
...
function go1()
    transition.to(comix1, {time=500, alpha=1, x=display.contentCenterX-500, y=display.contentCenterY+550})
    --comix1:scale( 3.9, 3.9 )
    nextpage1.alpha = 0;
    nextpage2.alpha = 1;
    nextpage3.alpha = 0;
...
comix1.x = display.contentCenterX + 485
comix1.y = display.contentCenterY + 550
comix1.alpha = 1
--bg.width = screenWidth
--bg.height = screenHeight
--comix1.rotation = 90
...
next_scene.goto = "scene10_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene8_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene9_official", false);
