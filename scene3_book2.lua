...
local comix1 = display.newImage("proassets/issue2/eng/5.png")
local comix1full = display.newImage("proassets/issue2/eng/5.png")
...
backpage_previous.goto = "scene2_book2"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene3_book2", false);
