...
local comix = display.newImage("proassets/issue1/eng/28.png")
comix:scale( 0.8, 0.8 )
...
nextpage.goto = "scene26_official"
nextpage.alpha = 0.8
nextpage.rotation = 0
...
backpage.goto = "scene24_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene25_official", false);
