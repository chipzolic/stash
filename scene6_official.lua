...
local comix1 = display.newImage("proassets/issue1/eng/8.png")
local comix1full = display.newImage("proassets/issue1/eng/8.png")
...
next_scene.goto = "scene7_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene5_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene6_official", false);
