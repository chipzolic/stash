...
local comix1 = display.newImage("proassets/issue1/eng/19.png")
local comix1full = display.newImage("proassets/issue1/eng/19.png")
...
next_scene.goto = "scene17_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene15_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene16_official", false);
