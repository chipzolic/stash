...
local comix1 = display.newImage("proassets/issue1/eng/27.png")
local comix1full = display.newImage("proassets/issue1/eng/27.png")
...
next_scene.goto = "scene25_official"
next_scene.alpha = 0
...
backpage_previous.goto = "scene23_official"
...
function scene:destroy( event )
    ...
    -- Example: remove display objects, save state, etc.
     ...
     composer.removeScene("scene24_official", false);
